...
// Golenishchev Artem, KE-220 Task 18 (1)
...
int main(int argc, char** argv) {
    ...
    // Суммирование локальных сумм в глобальную с использованием MPI_Reduce
    ...
    // Печать времени и использования памяти для каждого процесса
